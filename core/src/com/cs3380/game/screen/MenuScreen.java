...
public class MenuScreen extends Screen implements InputProcessor {
	...
	public void create() {
		...
		backgroundSkin.add("background", new Texture(Gdx.files.internal("logo.PNG")));
		...
		instrButton = new TextButton("INSTRUCTIONS", buttonSkin);
		
		playButton.getLabel().setFontScale(4, 4);
		instrButton.getLabel().setFontScale(4, 4);
